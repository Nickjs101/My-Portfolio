...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'An automated workflow using n8n and APIs to create and upload engaging YouTube Shorts from long-form content, streamlining video editing for podcasters.',
    type: 'Automation',
    image: YoutubeShortsAutomationCover,
    skills: ['n8n', 'KLAP AI API', 'YouTube API', 'RSS Feed Integration', 'Automation Workflows'],
    component: <YoutubeShortsAutomation />,
    links: {
      github: 'https://github.com/example/youtube-shorts-automation',
      live: null,
    },
  },
  {
