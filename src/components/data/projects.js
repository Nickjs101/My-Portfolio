...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'An automation tool using n8n and Klap API to convert videos into YouTube Shorts automatically, streamlining video editing and uploading processes.',
    type: 'Automation',
    image: YTShortsAutomationCover,
    skills: [
      'n8n',
      'Klap API',
      'YouTube API',
