...
import AppointmentSetterAIAgentSystem from '../../components/subcomponents/AppointmentSetterAgentAIAgentSystem.jsx';
...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'A tool that automates the creation and deployment of project showcase pages using AI and automation workflows.',
    type: 'Automation',
