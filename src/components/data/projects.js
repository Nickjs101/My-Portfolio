...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'An automated workflow that monitors YouTube video uploads and generates engaging Shorts using Klap AI, then uploads them via YouTube API, streamlining content creator workflows.',
    type: 'Automation',
    image: YTShortsCover,
    skills: ['Klap AI', 'YouTube API', 'RSS Feed', 'n8n Automation Tool'],
