...
import YTShortsAutomationImage from '/tmp/portfolio/src/assets/Works/youtubeshortsautomationcover.png';
...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'Automated workflow to generate and upload YouTube Shorts from existing videos using RSS feeds, Klap AI, and YouTube API.',
    type: 'Automation',
    image: YTShortsAutomationImage,
    skills: ['RSS Feed', 'Klap AI', 'YouTube API', 'n8n Automation'],
