...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'Automates video editing and uploading by generating YouTube Shorts from podcasts, streamlining content creation workflows.',
    type: 'Automation',
    image: YoutubeShortsAutomationCover,
    skills: ['RSS Feeds', 'Klap AI API', 'YouTube API', 'n8n (Automation Tool)'],
