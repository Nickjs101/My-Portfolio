...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'A tool that automates the creation and deployment of project showcase pages using AI and workflows to enhance portfolio efficiency.',
    type: 'Automation',
    image: pagegeneratorCover,
    skills: ['Git', 'n8n', 'GPT Language Models', 'Google Drive', 'Bash', 'Telegram', 'Netlify'],
