...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'Automated workflow for creating and uploading YouTube Shorts from podcasts and videos using KLAP AI and YouTube API.',
    type: 'Automation',
    image: YoutubeShortsAutomationCover,
    skills: ['RSS Feed Monitoring', 'KLAP AI', 'YouTube API', 'n8n'],
