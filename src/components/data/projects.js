...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'Automates creation and uploading of YouTube Shorts from existing videos, saving content creators time and effort.',
    type: 'Automation',
    image: YouTubeShortsAutomationCover,
    skills: ['Klap AI', 'YouTube API', 'RSS Feed', 'n8n', 'Automation Workflows'],
