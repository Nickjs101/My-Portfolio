...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'An AI-powered automated system that engages leads via conversational AI and schedules appointments, optimizing service provider workflows and improving customer engagement.',
    type: 'Automation',
  ...
  },
  {
    ...
    category: 'Automation',
    description:
      'An automation workflow using n8n and AI to generate and upload engaging YouTube Shorts from long podcasts automatically, reducing manual editing and publishing overhead.',
    type: 'Automation',
    image: YouTubeShortsAutomationCover,
    skills: ['Automation', 'n8n', 'KLAP AI', 'YouTube API', 'RSS Feed Management'],
    component: <YouTubeShortsAutomation />,
    links: {
      github: null,
      live: 'https://drive.google.com/file/d/1VUcpEdYc04WRkIY2vrkzVHf53kFy5v4B/view?usp=drivesdk',
    },
  },
  {
