...
export const Latest = [
  {
    ...
    description:
      'An AI-driven system that automates the creation of project showcase pages, streamlining portfolio updates and content generation.',
    type: 'SoftwareDevelopments',
    image: pagegeneratorCover,
    skills: ['Git', 'GPT language models', 'Google Drive', 'Bash', 'Telegram', 'Netlify', 'n8n'],
