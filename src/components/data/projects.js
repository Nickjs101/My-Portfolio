...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'An automation workflow that processes podcast videos into engaging YouTube Shorts, streamlining editing and uploading using RSS, Klap AI, and YouTube APIs.',
    type: 'Automation',
    image: YouTubeShortsAutomationCover,
    skills: ['RSS Feed', 'Klap AI', 'YouTube API', 'n8n Automation Platform'],
