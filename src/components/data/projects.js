...
export const Latest = [
  {
    ...
    category: "Automation",
    description: "An automated chat system leveraging AI to convert leads into scheduled appointments by integrating social media, automation workflows, and scheduling tools.",
    type: "Automation",
