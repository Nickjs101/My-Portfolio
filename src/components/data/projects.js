...
import YouTubeShortsAutomation from '../../components/subcomponents/YoutubeShortsAutomation.jsx';
...
export const Latest = [
  {
    ...
    category: 'Automation',
    description:
      'AI-powered system automating lead engagement and appointment scheduling via ManyChat and n8n integration, enhancing customer conversion.',
    type: 'Automation',
    image: AppointmentSetterAgentCover,
    skills: ['ManyChat', 'n8n Automation', 'Google Sheets', 'OpenAI GPT-4o', 'Cal.com for scheduling'],
  ...
  },
  {
    ...
    category: 'Automation',
    description:
      'Automates video editing and uploading for YouTube Shorts using Klap AI and YouTube API, streamlining content creation workflows.',
    type: 'Automation',
    image: YouTubeShortsAutomationCover,
    skills: ['RSS Feed', 'KLAP AI', 'YouTube API', 'n8n', 'Automation Workflow设计'],
