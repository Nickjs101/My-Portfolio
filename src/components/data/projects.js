...
export const Latest = [
  {
    ...
    category: "Automation",
    description: "An AI-powered system that automates lead engagement and appointment scheduling for service providers, enhancing customer interaction efficiency.",
    type: "Automation",
    image: AIAppointmentSetterCoverImage,
    skills: ["ManyChat", "n8n", "Google Sheets", "Cal.com", "OpenAI GPT-4"],
